...
class DpoPay
{
    ...
    public function __construct($companyToken, $serviceType, $testMode = false)
    {
        if ((int)$testMode === 1) {
    ...
    public function createToken($data)
    {
        ...
        $customerCountry   = $data['customerCountry'] ?? 'ZA';
...
POSTXML;
        ...
        if ($response != '') {
            ...
            if ($xml->xpath('Result')[0] != '000') {
                ...
                return [
                    'success'           => false,
                    'result'            => $xml->Result->__toString(),
                    'transToken'        => '',
                    'resultExplanation' => $xml->ResultExplanation->__toString(),
                    'transRef'          => '',
                ];
            } else {
